#CommuDev/settings.py
"""
Django settings for CommuDev project.
...
SECRET_KEY = "django-insecure-3%tt23m&cr^5j_q$o9cv8uj0)!6&grp50utyjox_-6*my$^4l8"
...
WSGI_APPLICATION = "CommuDev.wsgi.application"
